...
parser.add_argument('--result',  default='/data/result/', help='learning rate')
...
nyu_dataset = NYU_v2_datset(root_dir='/data/zfzhu/hlz/nyuv2/npy', transform=data_transform)
...
def validate(net, root_dir='/data/nyuv2/npy'):
